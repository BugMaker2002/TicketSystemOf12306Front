...
const AdminLogin = r => require.ensure([], () => r(require('@/page/AdminLogin')), 'AdminLogin');
const AdminManage = r => require.ensure([], () => r(require('@/page/AdminManage')), 'AdminLManage');
const AdminTrain = r => require.ensure([], () => r(require('@/page/AdminTrain')), 'AdminLTrain');
